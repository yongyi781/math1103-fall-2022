...
%\begin{Solution} Choose $N\geq 1/\ep^2$. 
%\end{Solution}
...
%In your formula you should factor each of the three terms inside $[\cdots]$ in the area formula, because this will make later work simpler.
...
\begin{center}
\begin{tikzpicture}[samples=100, domain=-1:2, scale=1.4]
